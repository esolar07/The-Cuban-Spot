              ...
              <div class="menu-part">
                <ul>
                  ...
                  <li class="has-child active">
                    ...
                    <ul class="sub-menu">
                      <li class="active"><a href="post-detail.html">Post Detail</a></li>
                    </ul>
                  </li>
        ...
        <section class="bread-crumb-container">
          ...
          <div class="bread-crumb-content">
            <div class="bread-crumb-inner">
              <h2>Post Detail</h2>
              <a href="index.html">Home</a> - <a href="post-detail.html">Post Detail</a>
            </div>
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <div class="event-detail-wrap">
                      <div class="event-list wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                        ...
                        <div class="tags"><span>TAGS:</span> food, weddings, truck</div>
                        <div class="post-link">
                          <div class="post-left-link">
                            <a href="javascript:;">Previous post</a>
                          </div>
                    ...
                    <div class="post-form">
                      <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-field">
                            <input name="txt" placeholder="* Email" type="email">
                          </div> <!-- form-field -->
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="form-field">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="form-field post-button-btn">
