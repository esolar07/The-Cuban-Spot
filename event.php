        ...
        <section class="bread-crumb-container">
          ...
          <div class="bread-crumb-content">
            <div class="bread-crumb-inner">
              <h2>events</h2>
              <a href="index.html">Home</a> - <a href="event.html">Events</a>
            </div>
            ...
            <div class="container">
              <div class="event-wrap">
                <div class="event-list wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                  ...
                  <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                ...
                <div class="event-list wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                  ...
                  <h3>Festival in San Francisco - 1:00 pm</h3>
                ...
                <div class="event-list wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                  ...
                  <h3>We make people smile on weddings</h3>
                  <span>5 august 2016</span>
                  <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                  <a href="javascript:;" class="btn-black">Read more</a>
                </div> <!-- event-list -->
                <div class="load-more wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms"><a href="javascript:;" class="btn-black">Load more</a></div>
              </div> <!-- event-wrap -->
            </div>
            ...
            <div class="row">
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="footer-column">
                  ...
                  <pThe Cuban Spot is bringing fantastic food right to you on the streets of Houston! Bringing this amazing menu from Florida to Texas, these Cuban dudes are serving up something great to sink your teeth into. Sandwiches, burgers, tostones, and more, The Cuban Spot has everything you could ever ask for! </p>
                  <div class="social">
                    <ul>
